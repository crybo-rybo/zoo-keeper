...
inline const std::string PLAIN_TEXT = "The capital of France is Paris.";
...
inline const std::string TOOL_CALL_ONLY = R"({"name": "greet", "arguments": {"name": "Alice"}})";
...
inline const std::string INVALID_JSON = R"({"name": "add", "arguments": {"a": 3, "b":)";
...
inline const std::string TOOL_CALL_STEP1 = R"({"name": "get_time", "arguments": {}})";

/// Final answer emitted after a tool result has been injected.
inline const std::string FINAL_ANSWER_STEP2 = "The current time is 2024-01-01T00:00:00Z.";

/// Tool call that uses incorrect argument names.
inline const std::string TOOL_CALL_WRONG_ARGS = R"({"name": "add", "arguments": {"x": 3, "y": 4}})";
